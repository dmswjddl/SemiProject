							...
							<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
								<div class="hero__caption">
									<h1 data-animation="fadeInLeft" data-delay=".4s"
										data-duration="2000ms">전자기기<br/> 통합 플랫폼</h1>
									<p data-animation="fadeInLeft" data-delay=".7s"
										data-duration="2000ms">여러분들이 본적 없는 다양한 전자기기 브랜드와 제품을 소개합니다</p>
									<!-- Hero-btn -->
									<div class="hero__btn" data-animation="fadeInLeft"
										data-delay=".8s" data-duration="2000ms">
										<a href="productListPage.do?num=1" class="btn hero-btn">Shop Now</a>
									</div>
								</div>
							</div>
							<div
