...
<head>
    ...
    <link rel="stylesheet" href="/semiProject/resources/assets/css/notice_qna.css">
</head>
    ...
    <div class="container">   
		<div class="container">
			<table class="table">
				<thead>
					<tr>
						<th scope="col">No.${qna.qNo}	${qna.qTitle}</th>
					</tr>
				</thead>
				<tbody>
					<tr>
				...
				<table class="table">
					...
					<tr>
						<th scope="col">작성일자 : ${qna.qrDate}</th>
					</tr>			
					<tr>
						<td height="150">${qna.qrContent}</td>
					</tr>	
				</table>		
				</c:if>
			</table>	
