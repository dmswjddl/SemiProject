...
<main>
		...
		<div class="row">
			...
			<div class='col-md-8' style ="padding-left: 10%; padding-rigt: 30%;">
			<table class="table table-hover" style="text-align:center;">
			<br><br><h3>스크랩목록</h3><br>
				<thead>
					<tr>
						<th width="10px" scope="col">  </th>
						<th width="50px" scope="col">상품명</th>
						<th width="50px" scope="col">가격</th>
						<th width="10x" scope="col">favorite</th>
					</tr>
				</thead>
				<tbody class="scrapList" style="vertical-align:center;">
				<c:forEach var="scrapList" items="${scrapList}" >
					<tr>
						<th scope="row"><img src="resources/img/${scarpList.storedFileName}" width="100px"></th>
						<td>${scrapList.pName}</td><!-- 상품명 -->
						<td>${scrapList.pPrice}</td><!-- 가격 -->
						<td><button style='background-color:transparent; border:0; outline:0;'><i class="bi bi-heart-fill"></i></button></td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
				...
				<ul class="pagination justify-content-center">
					...
					<c:forEach begin="1" end="${pageNum}" var="num">
						<li class="page-item"><a class="page-link"
							href="scrap.do?num=${num}">${num}</a></li>
					</c:forEach>
