...
<head>
    ...
    <link rel="stylesheet" href="/semiProject/resources/assets/css/contact.css">
     <link rel="stylesheet" href="/semiProject/resources/assets/css/map.css">
    ...
    <!-- CSS here -->
        ...
        <link rel="stylesheet" href="/semiProject/resources/assets/css/madeCss/map.css">
...
<body>
 <jsp:include page="../common/userHeader.jsp"/>
    <main>
 	...
 	<div id="wrapper">
 	 <div class="map_wrap" >
    <div id="map" style="width:550px;height:400px;overflow:hidden;"></div>
     <div id="menu_wrap" class="bg_white" >
        <div class="option">
            <div >
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="용산 전자상가" id="keyword" size="15"> 
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=16f11d974a72bc3536cde5ef5d28d00c&libraries=services"></script>
